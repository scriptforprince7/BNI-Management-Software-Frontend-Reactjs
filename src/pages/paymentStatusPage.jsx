    ...
    const fetchPaymentStatus = async () => {
      try {
        ...
        const [paymentResponse, orderResponse] = await Promise.all([
          axios.get(`${baseUrl}/api/orders/${order_id}/paymentStatus`),
          axios.get(`${baseUrl}/api/getOrder/${order_id}`)
        ]);
        setPaymentData(paymentResponse.data); // Assuming the status is part of this data
      ...
      case "SUCCESS":
        return (
          <div style={{ display: 'flex', flexDirection: "column", alignItems: "center" }}>
            <Receipt paymentData={paymentData} orderData={orderData} />
