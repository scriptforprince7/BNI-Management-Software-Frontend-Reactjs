        ...
        <div className="box-container" >
          <form className="form-content" onSubmit={handleSubmit} >
            <div className="form-left">
              ...
              <div className="form-group">
                <label htmlFor="renewalYear">Select Quarter</label>
                <select
                  id="renewalYear"
                  name="renewalYear"
                ...
                >
                 <option value="">Select Quartar</option>
              <option value="1Year">Jan-Mar(2024)</option>
              <option value="2Year">Apr-July(2024)</option>
              <option value="3Year">Aug-Sept(2024)</option>
              <option value="3Year">Oct-Dec(2024)</option>
                </select>
